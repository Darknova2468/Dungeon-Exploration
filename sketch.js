...
function preload() {
  textures = {
    ...
    blueDraconianTileSet: new AnimateSet("textures/blueDraconian.png", [23,17]),
    redDraconianTileSet: new AnimateSet("textures/redDraconian.png", [23,17]),
    fireBallTileSet: new AnimateSet("textures/fireBall.png", [12, 14]),
    blackDraconianTileSet: new AnimateSet("textures/blackDraconian.png", [23,17]),
    ...
    essenceTileSet: new TileSet("textures/essence.png", [11, 11]),
